...
namespace Boggle
{
    ...
    public class RestTestClient
    {
        ...
        /// <summary>
        /// Does a POST to the url, where the data is sent in the request body.
        ...
        /// <summary>
        /// Does a PUT to the url, where the data is sent in the request body.
        /// The response code and the response object is returned if the request was 
        /// successful; just the response code is returned if the request was unsuccessful.
        /// </summary>
